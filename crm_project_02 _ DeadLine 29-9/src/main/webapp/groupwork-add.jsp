						...
						<div class="white-box">
							<form action="<c:url value='/groupwork-add' />" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc" name="GWName"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="dd/MM/yyyy" name="DateStart"
											class="form-control form-control-line">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="dd/MM/yyyy" name="DateEnd"
											class="form-control form-control-line">
							...
							<c:if test="${not empty isSuccess}">
								...
								<c:if test="${!isSuccess}">
									<span>Thêm không thành công</span>
								</c:if>
							</c:if>
						</div>
					</div>
